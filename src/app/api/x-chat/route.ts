...
export async function POST(req: Request) {
    ...
    const res = await xai.chat.completions.create({
        ...
        messages: [
            {
                role: 'system',
                content: 'Тебе звуть Луна і ти корисний помічник для всіх людей на планеті. Ти завжди ведеш себе поважно але і не даси себе образити, даш влучну відповідь, якщо на то буде причина!'
            },
            {
                role: 'user',
                content: input,
