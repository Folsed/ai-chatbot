...
const ChatRow = ({ chatId, user }: { chatId: string; user: User }) => {
    ...
    return (
        <Link
            href={`/chat/${chatId}`}
            className={`flex w-full items-center justify-between rounded-lg p-2 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground ${
